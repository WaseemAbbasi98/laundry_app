...
class DryCleanMensServices extends StatefulWidget {
  final String type;
  const DryCleanMensServices({required this.type});

  @override
  _DryCleanMensServicesState createState() => _DryCleanMensServicesState();
}

class _DryCleanMensServicesState extends State<DryCleanMensServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = dmens.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: dmens[index].heading,
                          subheading: dmens[index].subheading,
                          price: dmens[index].price,
                          counter: dmens[index].counter,
                          image: dmens[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
...
class _JoblistState extends State<Joblist> {
  ...
  @override
  Widget build(BuildContext context) {
    String jobsubheading = widget.subheading;
                  ...
                  if (counter != 0) {
                    ...
                    if (counter == 0) {
                      ...
                      try {
                        ...
                        print('excaption occur ' + e.toString());
                      }
                    }
                  } else {
                    counter = 0;
                  ...
                  if (counter < 10) {
                    ...
                    if (counter == 1) {
                      jobDetailModel = itemdetailprovider.addtolist(
                          widget.heading, jobsubheading, widget.price, counter);
                    } else {
                      var filteredlist = itemdetailprovider.itemdetail
