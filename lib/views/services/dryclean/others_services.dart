...
class DryCleanOtherServices extends StatefulWidget {
  final String type;
  DryCleanOtherServices({required this.type});

  @override
  _DryCleanOtherServicesState createState() => _DryCleanOtherServicesState();
}

class _DryCleanOtherServicesState extends State<DryCleanOtherServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = dothers.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: dothers[index].heading,
                          subheading: dothers[index].subheading,
                          price: dothers[index].price,
                          counter: dothers[index].counter,
                          image: dothers[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
