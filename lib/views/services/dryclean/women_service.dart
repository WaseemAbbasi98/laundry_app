...
class DryCleanWomenServices extends StatefulWidget {
  final String type;
  const DryCleanWomenServices({required this.type});

  @override
  _DryCleanWomenServicesState createState() => _DryCleanWomenServicesState();
}

class _DryCleanWomenServicesState extends State<DryCleanWomenServices> {
  List detaillist = [];
  int counter = 0;
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: dwomen[index].heading,
                          subheading: dwomen[index].subheading,
                          price: dwomen[index].price,
                          counter: dwomen[index].counter,
                          image: dwomen[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
