...
class DryCleanJobsstate extends StatefulWidget {
  ...
  DryCleanJobsstate({Key? key, required this.sType}) : super(key: key);

  final String sType;
  @override
  _DryCleanJobsstateState createState() => _DryCleanJobsstateState();
}

class _DryCleanJobsstateState extends State<DryCleanJobsstate>
          ...
          children: <Widget>[
            ...
            Stack(
              children: <Widget>[
                Column(
                  children: <Widget>[
                    DryCleanWomenServices(type: widget.sType),
            ...
            Stack(
              children: <Widget>[
                Column(
                  children: <Widget>[
                    DryCleanOtherServices(type: widget.sType),
                    // selectedIndex == 2 ? Text('index2') : Text('index3'),
                    const SizedBox(
                      height: 10.0,
                    ),
