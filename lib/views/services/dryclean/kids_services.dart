...
class DryCleanKidsServices extends StatefulWidget {
  final String type;
  const DryCleanKidsServices({required this.type});

  @override
  _DryCleanKidsServicesState createState() => _DryCleanKidsServicesState();
}

class _DryCleanKidsServicesState extends State<DryCleanKidsServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = dkids.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: dkids[index].heading,
                          subheading: dkids[index].subheading,
                          price: dkids[index].price,
                          counter: dkids[index].counter,
                          image: dkids[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
                  ...
                  if (counter != 0) {
                    ...
                    if (counter == 0) {
                      ...
                      var filteredlist = itemdetailprovider.itemdetail
                          ...
                          .toList();
                      filteredlist[0].counter = ((filteredlist[0].counter) - 1);
                    }
                  } else {
                    counter = 0;
                  }
