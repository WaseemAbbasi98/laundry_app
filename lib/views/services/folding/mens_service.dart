...
class FoldingMensServices extends StatefulWidget {
  final String type;
  const FoldingMensServices({required this.type});

  @override
  _FoldingMensServicesState createState() => _FoldingMensServicesState();
}

class _FoldingMensServicesState extends State<FoldingMensServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = fmens.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: fmens[index].heading,
                          subheading: fmens[index].subheading,
                          price: fmens[index].price,
                          counter: fmens[index].counter,
                          image: fmens[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
