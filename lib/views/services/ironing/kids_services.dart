...
class IroningKidsServices extends StatefulWidget {
  final String type;
  const IroningKidsServices({required this.type});

  @override
  _IroningKidsServicesState createState() => _IroningKidsServicesState();
}

class _IroningKidsServicesState extends State<IroningKidsServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = ikids.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: ikids[index].heading,
                          subheading: ikids[index].subheading,
                          price: ikids[index].price,
                          counter: ikids[index].counter,
                          image: ikids[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
