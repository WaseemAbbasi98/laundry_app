...
class IroningWomenServices extends StatefulWidget {
  final String type;
  const IroningWomenServices({required this.type});

  @override
  _IroningWomenServicesState createState() => _IroningWomenServicesState();
}

class _IroningWomenServicesState extends State<IroningWomenServices> {
  List detaillist = [];
  int counter = 0;
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: iwomen[index].heading,
                          subheading: iwomen[index].subheading,
                          price: iwomen[index].price,
                          counter: iwomen[index].counter,
                          image: iwomen[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
