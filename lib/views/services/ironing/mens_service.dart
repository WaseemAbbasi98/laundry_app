...
class IroningMensServices extends StatefulWidget {
  final String type;
  const IroningMensServices({required this.type});

  @override
  _IroningMensServicesState createState() => _IroningMensServicesState();
}

class _IroningMensServicesState extends State<IroningMensServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = imens.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: imens[index].heading,
                          subheading: imens[index].subheading,
                          price: imens[index].price,
                          counter: imens[index].counter,
                          image: imens[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
