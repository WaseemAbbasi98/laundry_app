...
class KidsServices extends StatefulWidget {
  final String type;
  const KidsServices({required this.type});

  @override
  _KidsServicesState createState() => _KidsServicesState();
}
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: kids[index].heading,
                          subheading: kids[index].subheading,
                          price: kids[index].price,
                          counter: kids[index].counter,
