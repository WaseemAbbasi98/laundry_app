...
class WomenServices extends StatefulWidget {
  final String type;
  WomenServices({required this.type});

  @override
  _WomenServicesState createState() => _WomenServicesState();
}

class _WomenServicesState extends State<WomenServices> {
  List detaillist = [];
  int counter = 0;
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: women[index].heading,
                          subheading: women[index].subheading,
                          price: women[index].price,
                          counter: women[index].counter,
