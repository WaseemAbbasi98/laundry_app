...
class MensServices extends StatefulWidget {
  final String type;
  const MensServices({required this.type});

  @override
  _MensServicesState createState() => _MensServicesState();
}

class _MensServicesState extends State<MensServices> {
  List detaillist = [];
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = mens.length;
    return Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: mens[index].heading,
                          subheading: mens[index].subheading,
                          price: mens[index].price,
                          counter: mens[index].counter,
                          image: mens[index].image,
                          type: widget.type,
                          index: index,
                        ),
                      ),
